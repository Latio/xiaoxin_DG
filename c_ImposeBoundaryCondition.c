...
SurfNodeField ConvertMexToSurfField(const double *mxField, const int *Nfp_, const int *Ne_, int Nfield_) {
	SurfNodeField field;
...
void c_ImposeBoundaryCondition(double gra_, double *nx_, double *ny_, double *fp_, double *fext_, signed char *ftype_, int *Nfp_, int* Ne_, int Nfield_)
{
	...
	SurfNodeField fP = ConvertMexToSurfField(fp_, Nfp_, Ne_, Nfield_);
